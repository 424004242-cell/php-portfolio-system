            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status === 'success') {
                        ...
                        // Build profile detail rows from response.data fields.
                        // TODO: add more <li> rows as you add columns in get_profile.php.
                        //       Pattern: '<li class="list-group-item d-flex justify-content-between px-0">' +
                        //                '  <span class="text-muted">Label</span>' +
                        //                '  <strong>' + (d.your_column || '—') + '</strong>' +
                        //                '</li>'
                     success: function (response) {
    if (response.status === 'success') {
        const d = response.data;
        ...
        var image = '<div class="text-center mb-3">' +
        ...
        // ✅ FINAL OUTPUT (IMPORTANT: include image here)
        $('#aboutModalBody').html(
            image +
